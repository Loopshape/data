...
temp.dropdownmenu {
  ...
  wrap = <form action=""><p><select onchange="(this.selectedIndex >= 3 && this.selectedIndex <= 12) ? window.open(this.options[this.selectedIndex].value,'_blank') : window.location=this.options[this.selectedIndex].value;">|</select></p></form>
